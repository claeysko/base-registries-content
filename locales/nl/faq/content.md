...
U kan op basis van de verschillende read endpoints (https://basisregisters.staging-vlaanderen.be/producten/grar#readendpointsgrar) een lijst tonen met gegevens in.
