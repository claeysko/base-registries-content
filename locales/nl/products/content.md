...
### 1.1 Read endpoints {#readendpointsgrar}
...
### 1.2 Feed endpoints {#feedendpointsgrar}
...
### 1.3 Downloadbestand {#downloadbestandgrar}
...
#### 1.3.4 Bestanden crabHuisnummer & crabSubadres
...
### 1.4 WMS, WFS & OGC API features {#wmswfsogcgrar}
